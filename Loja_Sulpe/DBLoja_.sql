...
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS- CREATINA MONOHIDRATADA 250G -', 79.92, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS- CREATINA (250G) CREAPURE®  -', 103.50, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS- CREATINA MONOHIDRATADA 100G -', 40.50, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS- CREATINA (100) CREAPURE®  -', 45.50, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS- L-GLUTAMINA (250G)  -', 48.60, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-BETA-ALANINA EM PÓ -', 63.00, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-POWER ARGININE (120 CAPS) -', 27.00, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-BCAA 2:1:1 (120 cáps) -', 22.50, 1),
(LAST_INSERT_ID(),'-GROWTH SUPPLEMENTS- ARGININE POWER (250G) -', 54.90, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-BCAA 10:1:1 (200g) (em pó) -', 50.40, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-Amino Powder 10 - 200g -', 67.50, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-L-Carnitina (200g)', 79.20, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-Beta-Alanina 120 Comprimidos -', 74.79, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-Triptofano 120 caps  -', 36.00, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-Taurina Powder 250g   -', 40.50, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-L-Carnitina Líquida 2000 - 420ml -', 42.30, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-BCAA 5:1:1 (200g) (em pó) -', 45.90, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-BCAA 10:1:1 120 Comprimidos -', 63.00, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-BCAA 2:1:1 120 Comprimidos TAB -', 45.00, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-BCAA 2:1:1 (200g) (em pó) -', 42.50, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-Beta-Alanina 120 Comprimidos -', 74.70, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-L-LEUCINE (200G) -', 39.60, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-TRIPTOFANO ULTRA - 120 COMP  -', 99.00, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-HMB 90 CAPS  -', 35.10, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-TAURINA 1000MG 120 COMPRIMIDOS -', 54.00, 1),
(LAST_INSERT_ID(), '- Max Titanium -Creatina 300 g -', 110.00, 1),
(LAST_INSERT_ID(), '- Max Titanium -Creatina Creapure 250g -', 151.68, 1),
(LAST_INSERT_ID(), '- Max Titanium -Creatina Creapure 250g - Linha Dino -', 159.26, 1),
(LAST_INSERT_ID(), '- Max Titanium -Creatina 100g -', 60.62, 1),
(LAST_INSERT_ID(), '- Max Titanium -Creatina 120 Caps-', 68.21, 1),
(LAST_INSERT_ID(), '-Integralmedica-Creatina 100% Pura 300g -', 111.92, 1),
(LAST_INSERT_ID(), '-Integralmedica-Creatina com Carboidrato 300g -', 53.11, 1),
(LAST_INSERT_ID(), '-Integralmedica-Creatina 1kg em pó 100% pura-', 335.92, 1),
(LAST_INSERT_ID(), '-Integralmedica-Creatina Hardcore 150g-', 61.52, 1),
(LAST_INSERT_ID(), '-Integralmedica-Creatina em Cápsulas Hardcore 120 cáps-', 65.16, 1),
(LAST_INSERT_ID(), '-Integralmedica-Beta Alanina em Pó 123g-', 70.31, 1),
(LAST_INSERT_ID(), '-Integralmedica-Glutamina 300g em pó-', 71.32, 1),
(LAST_INSERT_ID(), '-Integralmedica-Creatina 100% Pura 60 Cápsulas-', 36.03, 1),
(LAST_INSERT_ID(), '-Integralmedica-L-Carn 2000-', 72.16, 1),
(LAST_INSERT_ID(), '-Integralmedica-BCAA 2044 mg', 48.27, 1),
(LAST_INSERT_ID(), '-Integralmedica-BEAA-9', 95.99, 1),
(LAST_INSERT_ID(), '-Integralmedica-Glutamina em Pó 150g-', 39.40, 1),
(LAST_INSERT_ID(), '-Integralmedica-Arginine 3000-', 79.20, 1),
(LAST_INSERT_ID(), '-Integralmedica-BCAA Top-', 85.91, 1),
(LAST_INSERT_ID(), '-Integralmedica-Bcaa Energy-', 93.52, 1),
(LAST_INSERT_ID(), '-Integralmedica-L-Carn 2000-', 84.15, 1);

insert into hipercalorico(id_produtos,nome,preco,quantidade)values
(LAST_INSERT_ID(),'-GROWTH SUPPLEMENTS-HIPER MASS (1KG) SABOR CHOCOLATE - ', 36.00, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-(TOP) HIPERCALÓRICO (SABOR CHOCOLATE) (1KG) -', 49.50, 1),
(LAST_INSERT_ID(), '-GROWTH SUPPLEMENTS-BIG MASS PRO HIPERCALÓRICO 3KG -', 144.00, 1),
(LAST_INSERT_ID(), '- Max Titanium-Mass Titanium Refil 3Kg -', 117.56, 1),
(LAST_INSERT_ID(), '- Max Titanium-Super Gainers Refil 3Kg-', 125.13, 1),
(LAST_INSERT_ID(), '- Max Titanium-Mass Titanium 17500 ZERO LACTOSE 2,4kg-', 110.00, 1),
(LAST_INSERT_ID(), '- Max Titanium-Super Whey 900G-', 75.85, 1),
(LAST_INSERT_ID(), '- Max Titanium-Mass Titanium Refil 1,4Kg-', 64.50, 1),
(LAST_INSERT_ID(), '-  Integralmedica -Creamass Hipercalorico com Creatina 3Kg-', 110.52, 1),
(LAST_INSERT_ID(), '-  Integralmedica -Nutri Whey Protein Pote 900g-', 82.94, 1),
(LAST_INSERT_ID(), '-  Integralmedica -Nutri Whey Protein  900g-', 75.04, 1),
(LAST_INSERT_ID(), '-  Integralmedica -Nutri Whey Protein  1,8Kg-', 134.22, 1);

INSERT INTO pre_treino (id_produtos, nome, preco, quantidade) VALUES
(LAST_INSERT_ID(), '- Growth Supplements-Pré-Treino Haze Hardcore 300g  -', 103.50, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Pré-treino Insanity 300g  -', 108.00, 1),
(LAST_INSERT_ID(), '- Max Titanium-Égide 300g  -', 151.71, 1),
(LAST_INSERT_ID(), '- Max Titanium-Horus 150g  -', 89.90, 1),
(LAST_INSERT_ID(), '- Integralmedica-Huger Pré-Treino 320g -', 111.93, 1),
(LAST_INSERT_ID(), '- Integralmedica-Beta Alanina em Pó 123g -', 70.31, 1);

INSERT INTO produtos (categoria, nome, preco, quantidade) VALUES
(LAST_INSERT_ID(), '- GROWTH SUPPLEMENTS -WHEY PROTEIN CONCENTRADO (1KG)', 108.00, 1),
(LAST_INSERT_ID(), '- GROWTH SUPPLEMENTS - DOSE WHEY PROTEIN CONCENTRADO 30GR)', 3.96, 1),
(LAST_INSERT_ID(), '- GROWTH SUPPLEMENTS - BEBIDA LÁCTEA UHT DE PROTEÍNAS', 5.67, 1),
(LAST_INSERT_ID(), '- GROWTH SUPPLEMENTS - BARRA DE PROTEÍNA (BARRINHA DE PROTEÍNA) - DISPLAY C/ 12 UN. ', 28.08, 1),
(LAST_INSERT_ID(), '- GROWTH SUPPLEMENTS - (TOP) WHEY PROTEIN CONCENTRADO 1KG', 114.90, 1),
(LAST_INSERT_ID(), '- GROWTH SUPPLEMENTS - WHEY PROTEIN CONCENTRADO 900G', 96.00, 1),
(LAST_INSERT_ID(), '- GROWTH SUPPLEMENTS - WHEY PROTEIN ISOLADO (900G)', 139.50, 1),
(LAST_INSERT_ID(), '- GROWTH SUPPLEMENTS - WHEY PROTEIN CONCENTRADO 900G', 96.00, 1),
(LAST_INSERT_ID(), '- Max Titanium-Whey Protein 900g-', 142.00, 1),
(LAST_INSERT_ID(), '- Max Titanium-Whey Protein Concentrado (900g)-', 132.00, 1),
(LAST_INSERT_ID(), '- Max Titanium-Whey Protein Concentrado (900g)- Isolado-', 139.00, 1),
(LAST_INSERT_ID(), '- Max Titanium-Whey Protein Concentrado 900g-', 137.00, 1),
(LAST_INSERT_ID(), '- Integralmedica-Whey Protein 900g-', 128.00, 1),
(LAST_INSERT_ID(), '- Integralmedica-Whey Protein Concentrado 1kg-', 178.00, 1),
(LAST_INSERT_ID(), '- Integralmedica-Whey Protein Isolado 1kg-', 199.99, 1);

INSERT INTO termogenicos (id_produtos, nome, preco, quantidade) VALUES
(LAST_INSERT_ID(), '- Growth Supplements-HOT Termogênico (60 Comprimidos) -', 37.80, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Óleo de Cártamo + Coco + Chia + Cromo + Vit. E (75 caps) -', 27.00, 1),
(LAST_INSERT_ID(), '- Growth Supplements-L-Carnitina Líquida 2000 - 420ml -', 42.30, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Gengibre em pó 250gr -', 21.60, 1),
(LAST_INSERT_ID(), '- Max Titanium-Shot Dry 150g -', 98.56, 1),
(LAST_INSERT_ID(), '- Max Titanium-2Hot 200G -', 87.18, 1),
(LAST_INSERT_ID(), '- Max Titanium-Fire Black 60 Caps-', 34.87, 1),
(LAST_INSERT_ID(), '- Max Titanium-Shot Thermo Max 60 Cáps-', 69.84, 1),
(LAST_INSERT_ID(), '- Max Titanium-L Carnitina 60 Caps-', 90.94, 1),
(LAST_INSERT_ID(), '- Max Titanium-Fire White 60 Caps-', 29.88, 1),
(LAST_INSERT_ID(), '- Max Titanium-L-Carnitine Pure 400Ml-', 83.39, 1),
(LAST_INSERT_ID(), '- Integralmedica-Therma Pro Hardcore-', 47.92, 1),
(LAST_INSERT_ID(), '- Integralmedica-Lipo Dry-', 107.91, 1),
(LAST_INSERT_ID(), '- Integralmedica-H2OUT - DIURETIC-', 78.21, 1);

-- Produtos Growth - Vitaminas

INSERT INTO vitaminas (id_produtos, nome, preco, quantidade) VALUES
(LAST_INSERT_ID(), '- Growth Supplements-Multivitamínico (120 cáps) (nova fórmula)- ', 36.90, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Óleo de Peixe Ultra (75 softgel) - ', 42.30, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Vitamina D ULTRA (2000UI) 120 caps  - ', 27.00, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Vitamina B12 com 120 cápsulas -', 19.80, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Cloreto de Magnésio 120 comp -', 18.00, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Coenzima Q10 -', 31.50, 1),
(LAST_INSERT_ID(), '- Growth Supplements- Vitamina C (120 caps)-', 14.40, 1),
(LAST_INSERT_ID(), '- Growth Supplements-ZMA (120 caps)-', 22.68, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Vitamina C + Zinco Efervescente Tubete c/ 10 Tabs -', 7.20, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Polivitamínico Mastigável 120Comp -', 23.40, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Vitamina K2 60 Cápsulas -', 19.80, 1),
(LAST_INSERT_ID(), '- Growth Supplements-NAC (N-ACETIL L-CISTEÍNA) 60CAPS-', 36.00, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Growth Skin 345g (Colágeno tipo 1 + Colágeno VERISOL® + Ácido Hialurônico + Vitamina C) -', 88.20, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Vitamina D (75 cápsulas)-', 13.50, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Óleo de Cártamo + Coco + Chia + Cromo + Vit. E (75 caps) -', 27.00, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Cálcio + Vitamina D + Vitamina K - 120 comp -', 63.00, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Picolinato de Cromo 120caps-', 18.00, 1),
(LAST_INSERT_ID(), '- Growth Supplements-HAIR SKIN GUMMY 30UN-', 36.00, 1),
(LAST_INSERT_ID(), '- Growth Supplements-Vitamina E (75caps)-', 13.50, 1),
(LAST_INSERT_ID(), '- Max Titanium-Omega 3 90 Caps-', 56.85, 1),
(LAST_INSERT_ID(), '- Max Titanium-Multimax Complex 90 Caps-', 56.85, 1),
(LAST_INSERT_ID(), '- Max Titanium- Vitamina D3 60 Caps', 60.62, 1),
(LAST_INSERT_ID(), '- Max Titanium- Vitamina C 500Mg-', 48.40, 1),
(LAST_INSERT_ID(), '- Max Titanium- CA - Óleo de Cártamo 120 Caps-', 63.85, 1),
(LAST_INSERT_ID(), '- Integralmedica-ZMA Testo Booster-', 39.92, 1),
(LAST_INSERT_ID(), '- Integralmedica- VitaPure Super-', 72.12, 1),
(LAST_INSERT_ID(), '- Integralmedica- 4 Sleep Night Time Recovery-', 53.32, 1),
(LAST_INSERT_ID(), '- Integralmedica- Reforz- C Immunity-', 90.12, 1);